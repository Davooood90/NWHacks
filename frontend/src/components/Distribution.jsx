...
import { Chart as ChartJS, CategoryScale, LinearScale, BarElement, BarController, Title, Tooltip, Legend } from 'chart.js';  // Import the BarController

// Register the necessary components, including BarController
ChartJS.register(CategoryScale, LinearScale, BarElement, BarController, Title, Tooltip, Legend);  // Register the BarController along with other components
