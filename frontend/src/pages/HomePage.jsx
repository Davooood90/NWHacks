...
const HomePage = () => {
  ...
  return (
    <>
      ...
      >
        <Circles size={20} offsetX={"88vw"} offsetY={"45vh"} />
        <Circles size={20} offsetX={"75vw"} offsetY={"55vh"} />
        <Circles size={20} offsetX={"80vw"} offsetY={"90vh"} />
        <Circles size={20} offsetX={"88vw"} offsetY={"80vh"} />
        <Circles size={20} offsetX={"89vw"} offsetY={"45vh"} />
        <Circles size={20} offsetX={"79vw"} offsetY={"55vh"} />
        <Circles size={20} offsetX={"80vw"} offsetY={"90vh"} />
        <Circles size={20} offsetX={"84vw"} offsetY={"65vh"} />

        <Circles size={50} offsetX={"88vw"} offsetY={"45vh"} />
        <Circles size={50} offsetX={"75vw"} offsetY={"55vh"} />
        <Circles size={50} offsetX={"80vw"} offsetY={"90vh"} />
        <Circles size={50} offsetX={"85vw"} offsetY={"65vh"} />

        <Circles size={150} offsetX={"75vw"} offsetY={"65vh"} />
        <Circles size={175} offsetX={"90vw"} offsetY={"45vh"} />
        <Circles size={300} offsetX={"85vw"} offsetY={"75vh"} />
      </Container>
      <Container
        maxWidth="md"
        sx={{
